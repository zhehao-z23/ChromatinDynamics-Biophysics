...
alpha=0.9; 
t_delta_n=1;% [0.25:0.25:2.5]
%delta_range=[0.05 0.25 0.5 2.5 5]/t_delta_n; %logspace(-2,1,4); 
delta_range=[0.05 0.5 5 50 500]/t_delta_n; %logspace(-2,1,4); 
...
vvcf=calc_vel_corr_new(alpha,delta_range,plot_range);
%
figure;
% 
